...
filename = 'C:\Users\pedro\OneDrive\Ambiente de Trabalho\DISSERTAÇÃO\Dataset\<name of file>.csv_labels.csv';
Original_labels_from_images = readtable(filename);
Original_labels_from_images(1,:) = [];
S = load("Pearson_labels.txt");
opts = detectImportOptions('Pearson_labels.txt');
tabela = readtable('Pearson_labels.txt',opts);
